...
// function filterTrainers() {
//     const selectedDirection = document.querySelector('.filters__input[name="direction"]:checked');
//     const selectedCategory = document.querySelector('.filters__input[name="category"]:checked');
	
//     let filteredTrainers = DATA;

//     if (selectedDirection && selectedDirection.value !== 'all') {
//         filteredTrainers = filteredTrainers.filter(trainer => trainer.specialization === selectedDirection.value);
//     }

//     if (selectedCategory && selectedCategory.value !== 'all') {
//         filteredTrainers = filteredTrainers.filter(trainer => trainer.category === selectedCategory.value);
//     }
// console.log(filteredTrainers);
//     renderTrainers(filteredTrainers);
